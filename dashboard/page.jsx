...
const handlePrenota = async () => {
  ...
  // Controlla se l'utente è bloccato dal proprietario di quel campo
  const { data: bloccato } = await supabase
  ...
  if (bloccato && bloccato.length > 0) {
    alert('Non puoi prenotare i campi di questo proprietario.')
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ── HERO BANNER ── */
        .db-hero {
          background: linear-gradient(120deg, #16a34a 0%, #22c55e 50%, #4ade80 100%);
          padding: 40px 0 44px;
          position: relative;
          overflow: hidden;
        }
            ...
            <div className="db-header-right">
              ...
              {profilo?.ruolo === 'proprietario' && (
                <button
                  ...
                  style={{
                    background: '#fef3c7', border: '1.5px solid #fde68a', color: '#d97706',
                    padding: '8px 16px', borderRadius: '10px', fontFamily: 'DM Sans, sans-serif',
        ...
        <main className="db-main">
          ...
          <div className="profilo-card">
            <div className="profilo-card-header">
              ...
              <div>
                <div className="profilo-card-title">Il tuo profilo</div>
